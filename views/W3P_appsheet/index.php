...
<html lang="en" dir="ltr">
  <head>
      ...
      <link rel="stylesheet" href="../../assets/css/W3P_appsheet/sections/section-1-home.css">
      <link rel="stylesheet" href="../../assets/css/W3P_appsheet/style.css">
  ...
  <body>
      ...
      <?php include "../../views/W3P_appsheet/sections/section-1-home.php" ?>

      <!-- Include JavaScript file for interactive functionality -->
      <script src="../../assets/js/global/menu.js" type="text/javascript"></script>
      <script  src="../../assets/js/W3P_appsheet/sections/section-1-home.js" type="text/javascript">
      </script>
  </body>
</html>
